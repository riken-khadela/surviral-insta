...
class CyberGhostVpn(BaseBot):
    ...
    def select_server(self, country='', city='', random_max_num=5):
        self.find_title_element_named_servers()  # wait a moment for freshing
        random_sleep()
    ...
    def start_ui(self, reconnect=True, country='', city='', retry_times=3,
                 check_connect_timeout=15, find_method='search'):
            ...
            try:
                ...
                if self.is_main_page():
                    ...
                    if find_method == 'search':
                        # btn = self.find_element('Search input element', self.location_selection_id,By.ID,timeout=2)    
    ...
    def wait_for_activity(self, activity, timeout=15, interval=1):
        try:
