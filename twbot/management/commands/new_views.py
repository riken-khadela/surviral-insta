...
class Command(BaseCommand):
    ...
    def run_tasks(self):
        ...
        while True:
            ...
            # all_users = [user_detail.objects.using('monitor').filter(avdsname='instagram_2263').first()]
            ...
            for userr in all_users:
                ...
                if userr.avdsname in df['avd'].values:
                    continue
                else:
                ...
                try:
                    ...
                    if tb.login(userr.username,userr.password) :
                        tb.send_views(AGENT,comment = userr.updated)
                        tb.follow_rio()
