...
class Command(BaseCommand):
    ...
    def run_tasks(self,i):
        ...
        while True:
            ...
            # all_users = list(User_details.objects.all())
            all_users = list(User_details.objects.filter(avdsname='instagram_3888').order_by('?'))
            ...
            for userr in all_users:
                ...
                if userr.avdsname in delete['avd'].values:continue
                            #    9825529411/.
                # if not int(userr.followers) > 20:
                #     continue
            ...
            # else :
                ...
                if userr.avd_pc and userr.avd_pc != os.getenv('PC'):
                    continue
                print(userr.status, userr.avd_pc)
                try:
