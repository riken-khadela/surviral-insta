...
from insta.basebot import BaseBot
...
from insta.dialogs import RateDialog, VpnConfirmDialog, MaximumDevicesReachedDialog
from insta.dialogs import AuthenticationErrorDialog, NewWifiDetectedDialog
